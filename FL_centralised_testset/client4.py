...
# Load dataset
infiltration = pd.read_csv("I:\\My Drive\\Colab Notebooks\\datasets\\data\\Prepared\\infiltration_trainval_set.csv")
print(infiltration.head())

# Split dataset
X = infiltration.drop(columns=['Label'])
y = infiltration['Label']
...
class FlowerClient(fl.client.NumPyClient):
    ...
    def fit(self, parameters, config):
        ...
        self.model.fit(self.X_train, self.y_train, validation_data=(self.X_val, self.y_val), epochs=20, batch_size=256, verbose=VERBOSE)
